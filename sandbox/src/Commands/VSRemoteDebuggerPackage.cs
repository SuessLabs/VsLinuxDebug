...
namespace VSRemoteDebugger
{
    ...
    public sealed class VSRemoteDebuggerPackage : AsyncPackage
    {
        ...
        public string DebugFolderPath => $"{AppFolderPath}/MyProject";  //// AppFolderPath + "/debug";
        public string ReleaseFolderPath => $"{AppFolderPath}/MyProject"; //// AppFolderPath + "/release";
